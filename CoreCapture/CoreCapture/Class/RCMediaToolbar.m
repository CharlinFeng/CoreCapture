...
const NSTimeInterval g_Max_Video_Duration = 60.0f;//动画的时长(其实就是停止视频录制的时长,可以弄成属性.)
...
- (void)rc_initSubviews
{
    ...
    [_closeBtn setImage:[UIImage imageNamed:@"rc_img.bundle/fanhui"] forState:UIControlStateNormal];
...
//    _cancelBtn.layer.borderWidth = 1.0;
    ...
    [_cancelBtn setImage:[UIImage imageNamed:@"rc_img.bundle/chehui"] forState:UIControlStateNormal];
...
//    [_doneBtn setTitle:@"done" forState:UIControlStateNormal];
    [_doneBtn setImage:[UIImage imageNamed:@"rc_img.bundle/queding"] forState:UIControlStateNormal];
    _doneBtn.imageView.contentMode = UIViewContentModeScaleAspectFit;
...
- (void)rc_initLayerOnView:(UIView *)theView
{
    ...
    _bgLayer.strokeColor = [[UIColor colorWithWhite:0 alpha:0.6] CGColor];
